...
import { APP_SCHEMA, validateDefinition } from "./appdef_C41c_UbP.mjs";
import { ALLOWED_PERMISSIONS, PRIVILEGED_PERMISSIONS } from "./apps_CR0L9h8o.mjs";
...
async function scanLeakedSecrets(ctx, text) {
  const { listApiKeyNames, getApiKey } = await import("./client_BlXSQX-O.mjs");

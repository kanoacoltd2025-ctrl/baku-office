...
import { getSession, canDevelopApps } from "./auth_Bpgz-Z3X.mjs";
import { l as loadDraft, c as checkDefinition, a as checkTransitions, b as checkSandbox, d as checkFabrication, e as checkRun, f as finalizePrecheck } from "./precheck_DEHfd6jR.mjs";
...
const POST = async ({ request, locals }) => {
  ...
  try {
    await (await import("./external-apps_alh5RdSP.mjs").then((n) => n.C)).recheckDraft(ctx, draftId);
  } catch {
  }

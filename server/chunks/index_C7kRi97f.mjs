...
const $$Index = createComponent(async ($$result, $$props, $$slots) => {
  ...
  const { cachedEntitlement, hasApiKey } = await import("./client_BlXSQX-O.mjs");
  ...
  const ttsCloudReady = await (await import("./capabilities_USXyoOsU.mjs")).ttsConfigured(env).catch(() => false);
  ...
  const [{ getMemberModel }, { listSkills }, { listScheduledTasks }] = await Promise.all([
    ...
    import("./skills_DcA02trz.mjs"),
    import("./scheduled-tasks_CGK-RNOU.mjs")
  ]);
